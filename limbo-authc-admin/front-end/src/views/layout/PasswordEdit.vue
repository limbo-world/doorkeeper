        ...
        <el-main>
            <el-form :model="account" label-width="120px" size="mini" class="edit-form" :rules="rules" ref="editForm">
                <el-form-item label="当前密码" prop="originalPassword">
                    <el-input v-model="account.originalPassword" :maxlength="50" type="password"></el-input>
                </el-form-item>
                <el-form-item label="新密码" prop="newPassword">
                    <el-input v-model="account.newPassword" :maxlength="50" type="password"></el-input>
                </el-form-item>
            ...
            updatePassword() {
                return new Promise((resolve, reject) => {
                    this.$refs.editForm.validate(valid => {
                        ...
                        this.$ajax.put(`/admin/${this.user.account.accountId}/password`, this.account).then((response) => {
                            resolve(response);
                        }).catch(reject);
                    });
                });
