...
package org.limbo.authc.admin.utils;
...
import org.limbo.authc.api.interfaces.constants.Sorts;
...
public class MyBatisPlusUtils {
     ...
     */
    public static <PO, VO> Page<PO> pageOf(org.limbo.authc.api.interfaces.beans.Page<VO> ipage) {
    ...
    public static <T> void batchUpdate(Collection<Wrapper<T>> wrappers, Class<T> poClass) {
    ...
    public static  <S extends T, T> boolean batchUpdateById(Collection<S> entityList, Class<T> modelClass) {
