...
public class RoleDao {
    ...
    public List<RolePO> getDefaultRole(Long realmId, Long clientId) {
        return roleMapper.selectList(Wrappers.<RolePO>lambdaQuery()
                .eq(RolePO::getRealmId, realmId)
                .eq(clientId != null, RolePO::getClientId, clientId)
