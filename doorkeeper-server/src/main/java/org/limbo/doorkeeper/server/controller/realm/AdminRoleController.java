...
@Slf4j
@RestController
@RequestMapping("/admin/realm/{realmId}/role")
public class AdminRoleController extends BaseController {
    ...
    public Response<RoleVO> add(@RequestBody @Validated RoleAddParam param) {
        return Response.success(roleService.add(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, param));
    }

    @Operation(summary = "查询角色列表")
    @GetMapping
    public Response<List<RoleVO>> list(@Validated RoleQueryParam param) {
        return Response.success(roleService.list(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, param));
    }

    @Operation(summary = "查询角色")
    @GetMapping("/{roleId}")
    public Response<RoleVO> get(@Validated @NotNull(message = "未提交角色ID") @PathVariable("roleId") Long roleId) {
        return Response.success(roleService.get(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, roleId));
    }
    ...
    public Response<RoleVO> update(@Validated @NotNull(message = "未提交角色ID") @PathVariable("roleId") Long roleId,
        ...
        roleService.update(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, roleId, param);
    ...
    public Response<List<RoleCombineVO>> list(@Validated @NotNull(message = "未提交角色ID") @PathVariable("roleId") Long roleId,
        ...
        return Response.success(roleCombineService.list(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, roleId, param));
    }
    ...
    public Response<List<RoleCombineVO>> batch(@Validated @NotNull(message = "未提交角色ID") @PathVariable("roleId") Long roleId,
        ...
        roleCombineService.batchUpdate(getRealmId(), DoorkeeperConstants.REALM_CLIENT_DEFAULT_ID, roleId, param);
        return Response.success();
    }
}
