 ...
 * @date 2021/1/18
 */
public class AllAuthorizationChecker<P extends AuthorizationCheckParam<Void>> extends AbstractAuthorizationChecker<P, Void> {
    ...
    public AllAuthorizationChecker(P checkParam) {
        super(checkParam);
    }
     ...
     */
    @Override
    protected List<ResourceVO> assignCheckingResources(List<Void> v) {
        return resourceDao.getAllVOS(getClient().getRealmId(), getClient().getClientId(), true);
    }
}
