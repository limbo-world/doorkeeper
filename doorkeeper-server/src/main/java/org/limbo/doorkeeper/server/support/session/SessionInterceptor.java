...
import org.limbo.doorkeeper.server.support.session.validate.SessionValidator;
import org.limbo.doorkeeper.server.support.session.validate.SessionValidatorFactory;
...
public class SessionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        // 验证签名
        SessionValidator v = SessionValidatorFactory.create(doorkeeperProperties, request);
