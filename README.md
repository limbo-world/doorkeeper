...
![项目架构图](https://github.com/LimboHome/limbo-authc/tree/master/doc/system.png?row=true)
...
![创建项目](https://github.com/LimboHome/limbo-authc/tree/master/doc/project.jpeg?row=true)

 2. 在权限管理后台创建项目的管理员账户，并将项目授权给管理员账户

![账户管理](https://github.com/LimboHome/limbo-authc/tree/master/doc/account.jpeg?row=true)

 3. 以项目管理员账户登陆权限管理后台，配置项目的权限、菜单、角色

![权限](https://github.com/LimboHome/limbo-authc/tree/master/doc/permission.jpeg?row=true)

![菜单](https://github.com/LimboHome/limbo-authc/tree/master/doc/menu.jpeg?row=true)

![菜单](https://github.com/LimboHome/limbo-authc/tree/master/doc/role.jpeg?row=true)
