...
public class TokenGenerator {
    ...
    /**
     * Generate and return a new session identifier 32 bit.
     */
    ...
    private SecureRandom createSecureRandom() {
        ...
        if (secureRandomClass != null) {
            try {
                ...
                log.debug("sessionIdGenerator.random" + secureRandomClass, e);
            }
        }
        ...
        if (result == null) {
            ...
            try {
                ...
                log.debug("sessionIdGenerator.randomAlgorithm" + secureRandomAlgorithm, e);
            } catch (NoSuchProviderException e) {
                log.debug("sessionIdGenerator.randomProvider" + secureRandomProvider, e);
            }
        }
        ...
        if ((t2 - t1) > 100)
            log.debug("sessionIdGenerator.createRandom" + result.getAlgorithm(), t2 - t1);
        return result;
    }
}