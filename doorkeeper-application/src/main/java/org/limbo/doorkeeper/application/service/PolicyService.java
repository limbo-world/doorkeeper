...
import org.limbo.doorkeeper.infrastructure.dao.mybatis.mapper.PermissionPolicyMapper;
...
import org.limbo.doorkeeper.infrastructure.dao.mybatis.mapper.policy.PolicyRoleMapper;
import org.limbo.doorkeeper.infrastructure.dao.mybatis.mapper.policy.PolicyUserMapper;
import org.limbo.doorkeeper.infrastructure.po.*;
import org.limbo.doorkeeper.server.infrastructure.utils.MyBatisPlusUtils;
import org.limbo.doorkeeper.server.useless.PermissionPolicyDao;
import org.limbo.doorkeeper.server.useless.PolicyGroupDao;
import org.limbo.doorkeeper.server.useless.PolicyRoleDao;
import org.limbo.doorkeeper.server.useless.PolicyUserDao;
...
public class PolicyService {
    ...
    public PolicyVO add(Long realmId, Long clientId, PolicyAddParam param) {
        ...
        try {
            ...
            throw new VerifyException("策略已存在");
        }
